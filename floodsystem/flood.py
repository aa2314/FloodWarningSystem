...
def stations_highest_rel_level(stations, N):
    ...
    tol10 = stations_level_over_threshold(stations, 0)[N][1]
    return stations_level_over_threshold(stations, tol10 - 1)[:N] # subtract 10 from relative level of 10th value just to be safe
